...
class FiscaliaScraper:
    ...
    def load_page(self, url: str):
        ...
        """
        self.logger.info(f"Cargando la página para URL : {url}")
    ...
    def extract_data(self) -> list:
        ...
        self.logger.info("Extrayendo filas de la tabla...")
    ...
    def save_data(self, data_objects: list[CompanyMetadata], output_path: str = "data/output.jsonl") -> None:
        """
    ...
    def trigger(self, url_key: str, output_path: str = "output.jsonl") -> None:
        """
